 ...
 * Admin Field Notes Detail Service
 *
 * ADD AS A NEW FMRCoreV3 FILE:
 *   AdminFieldNotesService
 *
 * Field notes remain in their authoritative immutable sources:
 *   - Material_Transactions.Notes
 *   - Backorder_Requests.Field_Notes
 *
 * Notes are loaded only when an Admin opens one FMR detail row.
 * Nothing is copied into FMR_Line_Items.
 */
